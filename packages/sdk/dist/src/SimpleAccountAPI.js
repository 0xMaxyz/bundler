...
class SimpleAccountAPI extends BaseAccountAPI_1.BaseAccountAPI {
    ...
    async _getAccountContract() {
        if (this.accountContract == null) {
            this.accountContract = utils_1.SimpleAccount__factory.connect(await this.getAccountAddress(), this.provider);
        }
    ...
    async getFactoryData() {
        if (this.factory == null) {
            if (this.factoryAddress != null && this.factoryAddress !== '') {
                this.factory = utils_1.SimpleAccountFactory__factory.connect(this.factoryAddress, this.provider);
            }
            else {
    ...
    async signUserOpHash(userOpHash) {
        return await this.owner.signMessage((0, utils_2.arrayify)(userOpHash));
    }
}
