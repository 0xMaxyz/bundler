...
const abi = Object.values([
    ...utils_2.SenderCreator__factory.abi,
    ...utils_2.IEntryPoint__factory.abi,
    ...utils_2.IPaymaster__factory.abi
].reduce((set, entry) => {
...
const callsFromEntryPointMethodSigs = {
    factory: utils_2.SenderCreator__factory.createInterface().getSighash('createSender'),
    account: utils_2.IAccount__factory.createInterface().getSighash('validateUserOp'),
    paymaster: utils_2.IPaymaster__factory.createInterface().getSighash('validatePaymasterUserOp')
};
/**
