...
export interface SimpleAccountFactoryInterface extends utils.Interface {
    functions: {
        "AddressOf(uint256)": FunctionFragment;
        "accountImplementation()": FunctionFragment;
        "createAccount(address,uint256)": FunctionFragment;
        "getAddress(address,uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "AddressOf" | "accountImplementation" | "createAccount" | "getAddress"): FunctionFragment;
    encodeFunctionData(functionFragment: "AddressOf", values: [PromiseOrValue<BigNumberish>]): string;
...
export interface SimpleAccountFactory extends BaseContract {
    ...
    functions: {
        AddressOf(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        accountImplementation(overrides?: CallOverrides): Promise<[string]>;
        createAccount(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        getAddress(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    };
    AddressOf(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    accountImplementation(overrides?: CallOverrides): Promise<string>;
    createAccount(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    filters: {};
    estimateGas: {
        AddressOf(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        accountImplementation(overrides?: CallOverrides): Promise<BigNumber>;
        createAccount(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        getAddress(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        AddressOf(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        accountImplementation(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        createAccount(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        getAddress(owner: PromiseOrValue<string>, name: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
