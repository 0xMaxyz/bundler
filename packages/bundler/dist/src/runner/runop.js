...
class Runner {
    ...
    async init(deploymentSigner) {
        ...
        const dep = new utils_2.DeterministicDeployer(this.provider);
        const accountDeployer = await utils_2.DeterministicDeployer.getAddress(new utils_2.SimpleAccountFactory__factory(), 0, [this.entryPointAddress]);
        ...
        if (!await dep.isContractDeployed(accountDeployer)) {
            ...
            const dep1 = new utils_2.DeterministicDeployer(deploymentSigner.provider, deploymentSigner);
            await dep1.deterministicDeploy(new utils_2.SimpleAccountFactory__factory(), 0, [this.entryPointAddress]);
        }
