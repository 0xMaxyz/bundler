...
class MempoolManager {
    ...
    checkMultipleRolesViolation(userOp) {
        ...
        const isPaymasterSenderViolation = knownSenders.includes((_a = paymaster === null || paymaster === void 0 ? void 0 : paymaster.toLowerCase()) !== null && _a !== void 0 ? _a : '');
        const isFactorySenderViolation = knownSenders.includes((_b = factory === null || factory === void 0 ? void 0 : factory.toLowerCase()) !== null && _b !== void 0 ? _b : '');
    ...
    getKnownEntities() {
        ...
        return res.filter(it => it != null).map(it => it.toLowerCase());
    }
}
