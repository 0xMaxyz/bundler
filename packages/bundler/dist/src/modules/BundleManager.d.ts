...
import { UserOperation, StorageMap, IEntryPoint } from '@account-abstraction/utils';
...
export declare class BundleManager {
    ...
    mutex: Mutex;
    constructor(entryPoint: IEntryPoint, eventsManager: EventsManager, mempoolManager: MempoolManager, validationManager: ValidationManager, reputationManager: ReputationManager, beneficiary: string, minSignerBalance: BigNumberish, maxBundleGas: number, conditionalRpc: boolean, mergeToAccountRootHash?: boolean);
    /**
