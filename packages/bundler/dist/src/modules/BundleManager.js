...
class BundleManager {
    ...
    async sendBundle(userOps, beneficiary, storageMap) {
        ...
        try {
            ...
            const tx = await this.entryPoint.populateTransaction.handleOps(userOps.map(utils_1.packUserOp), beneficiary, {
                type: 2,
            ...
            let parsedError;
            try {
                parsedError = this.entryPoint.interface.parseError((_b = (_a = e.data) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : e.data);
            }
            catch (e1) {
                this.checkFatal(e);
    ...
    async getUserOpHashes(userOps) {
        const { userOpHashes } = await (0, utils_1.runContractScript)(this.entryPoint.provider, new types_1.GetUserOpHashes__factory(), [this.entryPoint.address, userOps.map(utils_1.packUserOp)]);
        return userOpHashes;
    }
}
