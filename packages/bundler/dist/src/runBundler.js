...
const validation_manager_1 = require("@account-abstraction/validation-manager");
...
async function connectContracts(wallet, entryPointAddress) {
    const entryPoint = await (0, utils_1.deployEntryPoint)(wallet.provider, wallet);
    return {
        entryPoint
    };
}
...
async function runBundler(argv, overrideExit = true) {
    ...
    if (chainId === 31337 || chainId === 1337) {
        ...
        const ep = await (0, utils_1.deployEntryPoint)(provider);
